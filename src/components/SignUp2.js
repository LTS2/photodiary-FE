        ...
        <form id="signup-form" onSubmit={handleSignup}>
          <div className="input-group">
            <input
                ...
                onChange={(e) => {
                  ...
                  setUsernameError(''); // 사용자 입력 시 에러 초기화
                }}
          ...
          <input
              ...
              onChange={(e) => {
                ...
                validatePassword();
                setPasswordError(''); // 사용자 입력 시 에러 초기화
              }}
          ...
          <input
              ...
              onChange={(e) => {
                ...
                validateConfirmPassword();
                setConfirmPasswordError(''); // 사용자 입력 시 에러 초기화
              }}
          ...
          <div className="input-group">
            <input
                ...
                onChange={(e) => {
                  ...
                  validatePhoneNumber();
                  setPhoneNumberError(''); // 사용자 입력 시 에러 초기화
                }}
                placeholder="휴대폰 번호 입력 ('-' 제외 10-11자리 입력)"
                required
            />
          </div>
